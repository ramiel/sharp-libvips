...
VERSION_SVG=2.45.5
VERSION_GIF=5.1.4
VERSION_POPPLER=0.26.5
# VERSION_POPPLER=0.74.0
...
# version_latest "poppler" "$VERSION_POPPLER" "3686" # atest version requires a too recent cmake
...
# mkdir ${DEPS}/poppler
# curl -Lks https://poppler.freedesktop.org/poppler-${VERSION_POPPLER}.tar.xz | tar xJC ${DEPS}/poppler --strip-components=1
# cd ${DEPS}/poppler
# mkdir build
# cd build
